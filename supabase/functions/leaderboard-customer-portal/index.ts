...
const logStep = (step: string, details?: any) => {
  ...
  console.log(`[LEADERBOARD-CUSTOMER-PORTAL] ${step}${detailsStr}`);
};
...
serve(async (req) => {
  ...
  try {
    ...
    if (entitlement?.stripe_customer_id) {
      ...
      logStep("Found customer ID from entitlement", { customerId });
    } else {
      ...
      logStep("Found customer ID from Stripe search", { customerId });
    }
