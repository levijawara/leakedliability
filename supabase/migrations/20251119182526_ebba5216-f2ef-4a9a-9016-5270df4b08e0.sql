-- Add 3-day grace period to PSCS scoring
-- This prevents very short delays (0-3 days) from immediately tanking producer scores
...
BEGIN
  ...
  -- effective_days_overdue = max(actual_days_overdue - 3, 0)
  -- Example: 3 days late = 0 penalty, 4 days late = 1 effective day, 10 days late = 7 effective days
  SELECT 
