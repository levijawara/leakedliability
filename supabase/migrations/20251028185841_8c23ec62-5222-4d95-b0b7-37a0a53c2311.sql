-- ============================================================================
-- PSCS™ Fairness System - Complete Implementation (Idempotent)
-- ============================================================================

-- Step 1: Create past_debts table for historical tracking (if not exists)
...
DROP POLICY IF EXISTS "Authenticated users can view own past debts" ON public.past_debts;
DROP POLICY IF EXISTS "Admins can view all past debts" ON public.past_debts;
DROP POLICY IF EXISTS "System can insert past debts" ON public.past_debts;
...
DROP TRIGGER IF EXISTS trigger_log_past_debt_on_resolve ON payment_reports;
