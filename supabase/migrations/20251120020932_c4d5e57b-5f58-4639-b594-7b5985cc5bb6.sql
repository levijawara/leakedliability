-- Remove age penalty cap from PSCS calculation
-- Allow age penalty to grow unbounded for increasingly overdue debts
...
DECLARE
  ...
  age_cap NUMERIC;  -- kept for backwards compatibility but not used
  amount_rate NUMERIC;
  amount_cap NUMERIC;
...
BEGIN
  ...
  -- Calculate CREW Age Penalty (NO CAP - REMOVED LEAST())
  ...
  -- Calculate VENDOR Age Penalty (NO CAP - REMOVED LEAST())
