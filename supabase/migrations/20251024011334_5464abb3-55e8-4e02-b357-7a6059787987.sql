...
DROP POLICY IF EXISTS "Producers can insert their own self-reports" ON public.producer_self_reports;
DROP POLICY IF EXISTS "Producers can view their own self-reports" ON public.producer_self_reports;
DROP POLICY IF EXISTS "Admins can manage all self-reports" ON public.producer_self_reports;
